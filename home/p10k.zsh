# Generated by Powerlevel10k configuration wizard on 2024-01-07 at 17:38 AEDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh.
# Wizard options: powerline, unicode, lean_8colors, 24h time, 2 lines, dotted, no frame,
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # If local branch name is at most 100 characters long, show it in full.
      # Otherwise show the first 40 … the last 40.
      # Tip: To always show local branch name in full without truncation, delete the next line.
      (( $#branch > 100 )) && branch[41,-41]="…"  # <-- this line
    ...
    if [[ -n $VCS_STATUS_TAG
      ...
      # If tag name is at most 100 characters long, show it in full.
      # Otherwise show the first 40 … the last 40.
      # Tip: To always show tag name in full without truncation, delete the next line.
      (( $#tag > 100 )) && tag[41,-41]="…"  # <-- this line
      res+="${meta}#${clean}${tag//\%/%%}"
    fi
    ...
    # *42 if have stashes.
    # Override: I don't really care about the number of stashes I have
